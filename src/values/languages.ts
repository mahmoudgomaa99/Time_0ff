const languages: any = {
  en: {
    ...
    requestReceive: 'We will confirm your booking within 24 hours stay tuned',
    activity: 'Activities',
    ...
    unableToCompleteBooking: 'Unable to complete booking',
    unableToCompleteOrder: 'Unable to complete order',
    sortBy: ' Sort By',
    trending: 'Trending',
    location: 'Location',
    ...
    journeys: 'Journeys',
    addJourney: 'Add Activity',
    journey_name: 'Activity Name',
  ...
  ar: {
    ...
    requestReceive: 'يرجي الانتظار ٢٤ ساعة لتاكيد طلب الحجز كن علي استعداد',
    activity: 'انشطه',
    ...
    sorry: 'عذراً',
    unableToCompleteBooking: 'لا يمكن اتمام الحجز',
    unableToCompleteOrder: 'لا يمكن اتمام الطلب',
    createOne: 'انشئ واحدا',
    sortBy: 'رتب حسب',
    trending: 'الشائع',
    location: 'الموقع',
