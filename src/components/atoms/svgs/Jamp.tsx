...
function SvgComponent({ size, bgColor, txtColor, ...props }: TSvgProps) {
  ...
  return (
    <Svg {...computedSize} viewBox="0 0 16 16" {...props}>
      <Defs>
        <Pattern
          id="pattern"
